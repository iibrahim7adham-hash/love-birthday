...
export const BLOWOUT_BUTTON_TEXT = "انفخ الشموع";
...
export const BLOWOUT_BUTTON_ENTER_DELAY = 6.2;
export const BLOWOUT_BUTTON_ENTER_DURATION = 0.9;
...
export const BLOWOUT_FLAME_REACT_DURATION = 0.2;
export const BLOWOUT_FLAME_SHRINK_DURATION = 0.3;
export const BLOWOUT_FLAME_VANISH_DURATION = 0.3;
export const BLOWOUT_FLAME_STAGGER = 0.05;
...
export const BLOWOUT_SMOKE_START_DELAY = 0.35; // relative to button press
export const BLOWOUT_SMOKE_COUNT_PER_CANDLE = 3;
export const BLOWOUT_SMOKE_STAGGER = 0.12;
...
export const BLOWOUT_SMOKE_DURATION_MIN = 1.3;
export const BLOWOUT_SMOKE_DURATION_MAX = 1.9;
...
// window.
export const BLOWOUT_LIGHTING_DIM_START_DELAY = 0.5; // relative to button press
...
// begins.
export const BLOWOUT_DARK_PAUSE_DURATION = 0.45;
