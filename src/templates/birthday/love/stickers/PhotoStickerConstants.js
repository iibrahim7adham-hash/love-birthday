...
// Retimed from 1.5s to 0.8s (further trimming the overall pre-envelope
// wait) — the overlap still holds since messages are continuously
// falling well past this point either way.
export const PHOTO_STICKER_START_DELAY = 0.8;
...
// Retimed from 0.18s/1.1s, then 0.14s/0.85s — same staggered
// pop-in-one-by-one entrance, just quicker per sticker.
export const PHOTO_STICKER_ENTRANCE_STAGGER = 0.06;
export const PHOTO_STICKER_FADE_IN_DURATION = 0.45;
